...
namespace PupV1.Migrations
{
    ...
    [Migration("20251024201503_AddTrequestIdToTrainingProgress")]
    partial class AddTrequestIdToTrainingProgress
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PupV1.Models.TrainingProgress", b =>
                {
                    ...
                    b.Property<int?>("TrainingrequestTrequestId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TrainingrequestTrequestId");
            ...
            modelBuilder.Entity("PupV1.Models.TrainingProgress", b =>
                {
                    ...
                    b.HasOne("PupV1.Models.Trainingrequest", null)
                        .WithMany("TrainingProgresses")
                        .HasForeignKey("TrainingrequestTrequestId");
